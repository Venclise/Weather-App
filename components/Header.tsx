...
const Header = ({ searchQuery, setSearchQuery, handleSearch }) => {
  ...
  return (
    <div className="w-full h-[3rem] flex items-center justify-between p-10 max-sm:p-5">
...
<Cloud />
      ...
      <form onSubmit={(e) => {   
 e.preventDefault() 
  handleSearch()}} className="w-max max-sm:w-[13rem]  h-[2.5rem] flex items-center border border-gray-100 pl-2 pr-2 rounded-md">
        <input type="text"
          value={searchQuery}
